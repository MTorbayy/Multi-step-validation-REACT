...
export default function HateLove(props) {
  ...
  onSubmit={preventFunc}>
    ...
    <p>Parle-nous des aliments que tu préfères et de ce que tu détestes !</p>
    ...
    <label htmlFor="prefered">Les aliments que tu ne supportes pas, séparés par une virgule :</label>
    <textarea 
